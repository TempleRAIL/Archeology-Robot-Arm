...
def process_sherds():
    ...
    core.calibrate_fun() # TODO add calibration to state machine
    ...
    with sm:
        ...
        smach.StateMachine.add('Zero', Zero(core), transitions = {'not_ready': 'NotReady', 'ready': 'Examine'})
    ...
    # TODO add behavior for arm to move out of way of camera when taking picture
